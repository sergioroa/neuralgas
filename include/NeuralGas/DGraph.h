...
*
* TO DO : the number of connected components should be re-implemented since there is no
*        differentiation betweeen ingoing and outgoing edges.
*/


template<typename T,typename S> class DGraph : virtual public Base_Graph<T,S>
{
  public:
...
{
  return ( (*_nodes[x])[y] != NULL && (*_nodes[y])[x] != NULL);
} 
